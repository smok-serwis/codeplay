...
kredyty = pd.read_csv(r"C:\Users\Szymon\Desktop\Hackathon\KREDYTY.csv", sep='\t', delimiter=',', encoding ="ISO-8859-1", error_bad_lines=False)
polisy = pd.read_csv(r"C:\Users\Szymon\Desktop\Hackathon\POLISY.csv", sep='\t', delimiter=',', encoding ="ISO-8859-1", error_bad_lines=False)
